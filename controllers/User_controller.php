    ...
    public function registrar(){      // metodo que nos resgistra al usuario  
        if (isset($_POST['registrar'])) {
            ...
            if ($usuarioExiste) {
                ...
                $resul=$usuario->set_Registrar($_POST['email'], $_POST['contrasenia']);//registro de usuario
                $resul ?  $usuarioRegistrado = "Usuario registrado conexito!!!": $informacion[]="ocurrio un error durante el registro";
                require_once 'views/user/registro.php';
                exit;
